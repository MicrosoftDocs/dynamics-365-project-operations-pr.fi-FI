...
<span data-ttu-id="9b2c5-111">Seuraavassa taulukossa on täydellinen luettelo **Aikataulutusentiteeteistä**.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-111">The following table provides a full list of the **Scheduling entities**.</span></span>
...
| <span data-ttu-id="9b2c5-201">msdyn_actualsales</span><span class="sxs-lookup"><span data-stu-id="9b2c5-201">msdyn_actualsales</span></span>                      | <span data-ttu-id="9b2c5-202">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-202">no</span></span>             | <span data-ttu-id="9b2c5-203">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-203">no</span></span>               |
...
| <span data-ttu-id="9b2c5-243">msdyn_LinkStatus</span><span class="sxs-lookup"><span data-stu-id="9b2c5-243">msdyn_LinkStatus</span></span>                       | <span data-ttu-id="9b2c5-244">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-244">no</span></span>             | <span data-ttu-id="9b2c5-245">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-245">no</span></span>               |
...
| <span data-ttu-id="9b2c5-285">msdyn_resourcecategory</span><span class="sxs-lookup"><span data-stu-id="9b2c5-285">msdyn_resourcecategory</span></span>                 | <span data-ttu-id="9b2c5-286">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-286">no</span></span>             | <span data-ttu-id="9b2c5-287">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-287">no</span></span>               |
...
| <span data-ttu-id="9b2c5-327">msdyn_skipupdateestimatelinename</span><span class="sxs-lookup"><span data-stu-id="9b2c5-327">msdyn_skipupdateestimatelinename</span></span>       | <span data-ttu-id="9b2c5-328">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-328">no</span></span>             | <span data-ttu-id="9b2c5-329">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-329">no</span></span>               |
...
| <span data-ttu-id="9b2c5-367">msdyn_successortaskname</span><span class="sxs-lookup"><span data-stu-id="9b2c5-367">msdyn_successortaskname</span></span>       | <span data-ttu-id="9b2c5-368">kyllä</span><span class="sxs-lookup"><span data-stu-id="9b2c5-368">yes</span></span>            | <span data-ttu-id="9b2c5-369">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-369">no</span></span>           |
...
| <span data-ttu-id="9b2c5-410">msdyn_plannedcostcontour</span><span class="sxs-lookup"><span data-stu-id="9b2c5-410">msdyn_plannedcostcontour</span></span>     | <span data-ttu-id="9b2c5-411">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-411">no</span></span>             | <span data-ttu-id="9b2c5-412">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-412">no</span></span>           |
...
| <span data-ttu-id="9b2c5-492">msdyn_percentage</span><span class="sxs-lookup"><span data-stu-id="9b2c5-492">msdyn_percentage</span></span>                                 | <span data-ttu-id="9b2c5-493">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-493">no</span></span>             | <span data-ttu-id="9b2c5-494">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-494">no</span></span>           |
...
| <span data-ttu-id="9b2c5-616">msdyn_remainingsales_base</span><span class="sxs-lookup"><span data-stu-id="9b2c5-616">msdyn_remainingsales_base</span></span>              | <span data-ttu-id="9b2c5-617">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-617">no</span></span>             | <span data-ttu-id="9b2c5-618">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-618">no</span></span>           |
...
| <span data-ttu-id="9b2c5-628">msdyn_salesestimateatcompleteeac_base</span><span class="sxs-lookup"><span data-stu-id="9b2c5-628">msdyn_salesestimateatcompleteeac_base</span></span>  | <span data-ttu-id="9b2c5-629">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-629">no</span></span>             | <span data-ttu-id="9b2c5-630">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-630">no</span></span>           |
| <span data-ttu-id="9b2c5-631">msdyn_salesvariance</span><span class="sxs-lookup"><span data-stu-id="9b2c5-631">msdyn_salesvariance</span></span>                    | <span data-ttu-id="9b2c5-632">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-632">no</span></span>             | <span data-ttu-id="9b2c5-633">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-633">no</span></span>           |
| <span data-ttu-id="9b2c5-634">msdyn_salesvariance_base</span><span class="sxs-lookup"><span data-stu-id="9b2c5-634">msdyn_salesvariance_base</span></span>               | <span data-ttu-id="9b2c5-635">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-635">no</span></span>             | <span data-ttu-id="9b2c5-636">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-636">no</span></span>           |
| <span data-ttu-id="9b2c5-637">msdyn_scheduleperformance</span><span class="sxs-lookup"><span data-stu-id="9b2c5-637">msdyn_scheduleperformance</span></span>              | <span data-ttu-id="9b2c5-638">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-638">no</span></span>             | <span data-ttu-id="9b2c5-639">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-639">no</span></span>           |
| <span data-ttu-id="9b2c5-640">msdyn_scheduleperformancename</span><span class="sxs-lookup"><span data-stu-id="9b2c5-640">msdyn_scheduleperformancename</span></span>          | <span data-ttu-id="9b2c5-641">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-641">no</span></span>             | <span data-ttu-id="9b2c5-642">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-642">no</span></span>           |
| <span data-ttu-id="9b2c5-643">msdyn_schedulevariance</span><span class="sxs-lookup"><span data-stu-id="9b2c5-643">msdyn_schedulevariance</span></span>                 | <span data-ttu-id="9b2c5-644">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-644">no</span></span>             | <span data-ttu-id="9b2c5-645">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-645">no</span></span>           |
| <span data-ttu-id="9b2c5-646">msdyn_taskearlieststart</span><span class="sxs-lookup"><span data-stu-id="9b2c5-646">msdyn_taskearlieststart</span></span>                | <span data-ttu-id="9b2c5-647">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-647">no</span></span>             | <span data-ttu-id="9b2c5-648">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-648">no</span></span>           |
| <span data-ttu-id="9b2c5-649">msdyn_teamsize</span><span class="sxs-lookup"><span data-stu-id="9b2c5-649">msdyn_teamsize</span></span>                         | <span data-ttu-id="9b2c5-650">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-650">no</span></span>             | <span data-ttu-id="9b2c5-651">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-651">no</span></span>           |
| <span data-ttu-id="9b2c5-652">msdyn_teamsize_date</span><span class="sxs-lookup"><span data-stu-id="9b2c5-652">msdyn_teamsize_date</span></span>                    | <span data-ttu-id="9b2c5-653">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-653">no</span></span>             | <span data-ttu-id="9b2c5-654">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-654">no</span></span>           |
| <span data-ttu-id="9b2c5-655">msdyn_teamsize_state</span><span class="sxs-lookup"><span data-stu-id="9b2c5-655">msdyn_teamsize_state</span></span>                   | <span data-ttu-id="9b2c5-656">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-656">no</span></span>             | <span data-ttu-id="9b2c5-657">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-657">no</span></span>           |
| <span data-ttu-id="9b2c5-658">msdyn_totalactualcost</span><span class="sxs-lookup"><span data-stu-id="9b2c5-658">msdyn_totalactualcost</span></span>                  | <span data-ttu-id="9b2c5-659">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-659">no</span></span>             | <span data-ttu-id="9b2c5-660">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-660">no</span></span>           |
| <span data-ttu-id="9b2c5-661">msdyn_totalactualcost_base</span><span class="sxs-lookup"><span data-stu-id="9b2c5-661">msdyn_totalactualcost_base</span></span>             | <span data-ttu-id="9b2c5-662">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-662">no</span></span>             | <span data-ttu-id="9b2c5-663">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-663">no</span></span>           |
| <span data-ttu-id="9b2c5-664">msdyn_totalplannedcost</span><span class="sxs-lookup"><span data-stu-id="9b2c5-664">msdyn_totalplannedcost</span></span>                 | <span data-ttu-id="9b2c5-665">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-665">no</span></span>             | <span data-ttu-id="9b2c5-666">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-666">no</span></span>           |
| <span data-ttu-id="9b2c5-667">msdyn_totalplannedcost_base</span><span class="sxs-lookup"><span data-stu-id="9b2c5-667">msdyn_totalplannedcost_base</span></span>            | <span data-ttu-id="9b2c5-668">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-668">no</span></span>             | <span data-ttu-id="9b2c5-669">ei</span><span class="sxs-lookup"><span data-stu-id="9b2c5-669">no</span></span>           |


## <a name="limitations-and-known-issues"></a><span data-ttu-id="9b2c5-670">Rajoitukset ja tunnetut ongelmat</span><span class="sxs-lookup"><span data-stu-id="9b2c5-670">Limitations and known issues</span></span>
<span data-ttu-id="9b2c5-671">Seuraavassa on luettelo rajoituksista ja tunnetuista ongelmista:</span><span class="sxs-lookup"><span data-stu-id="9b2c5-671">The following is a list of limitations and known issues:</span></span>

- <span data-ttu-id="9b2c5-672">Aikataulutuksen ohjelmointirajapintoja voivat käyttää vain **käyttäjät, joilla on Microsoft Project -lisenssi.**</span><span class="sxs-lookup"><span data-stu-id="9b2c5-672">Schedule APIs can only be used by **Users with Microsoft Project License.**</span></span> <span data-ttu-id="9b2c5-673">Niitä eivät voi käyttää:</span><span class="sxs-lookup"><span data-stu-id="9b2c5-673">They can't be used by:</span></span>
    - <span data-ttu-id="9b2c5-674">Sovelluksen käyttäjät</span><span class="sxs-lookup"><span data-stu-id="9b2c5-674">Application users</span></span>
    - <span data-ttu-id="9b2c5-675">Järjestelmäkäyttäjät</span><span class="sxs-lookup"><span data-stu-id="9b2c5-675">System users</span></span>
    - <span data-ttu-id="9b2c5-676">Integrointikäyttäjät</span><span class="sxs-lookup"><span data-stu-id="9b2c5-676">Integration users</span></span>
    - <span data-ttu-id="9b2c5-677">Muut käyttäjät, joilla ei ole tarvittavaa lisenssiä</span><span class="sxs-lookup"><span data-stu-id="9b2c5-677">Other users that don't have the required license</span></span>
- <span data-ttu-id="9b2c5-678">Kussakin **OperationSet** issä voi olla enintään 100 toimintoa.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-678">Each **OperationSet** can only have a maximum of 100 operations.</span></span>
- <span data-ttu-id="9b2c5-679">Kullakin käyttäjällä voi olla enintään 10 avointa **OperationSet** iä.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-679">Each user can only have a maximum of 10 open **OperationSets**.</span></span>
- <span data-ttu-id="9b2c5-680">Project Operations tukee tällä hetkellä projektissa enintään 500 tehtävää.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-680">Project Operations currently supports a maximum of 500 total tasks on a project.</span></span>
- <span data-ttu-id="9b2c5-681">**OperationSet**-virheen tila- ja virhelokit eivät ole tällä hetkellä käytettävissä.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-681">**OperationSet** failure status and failure logs aren't currently available.</span></span>
- [<span data-ttu-id="9b2c5-682">Projektien ja tehtävien rajoitukset ja rajat</span><span class="sxs-lookup"><span data-stu-id="9b2c5-682">Limits and boundaries on projects and tasks</span></span>](/project-for-the-web/project-for-the-web-limits-and-boundaries)

## <a name="error-handling"></a><span data-ttu-id="9b2c5-683">Virheen käsittely</span><span class="sxs-lookup"><span data-stu-id="9b2c5-683">Error handling</span></span>

   - <span data-ttu-id="9b2c5-684">Voit tarkastella toimintojoukoista luotuja virheitä kohdassa **Asetukset** \> **Aikatauluta integrointi** \> **Toimintojoukot**.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-684">To review errors generated from the Operation Sets, go to **Settings** \> **Schedule Integration** \> **Operations Sets**.</span></span>
   - <span data-ttu-id="9b2c5-685">Voit tarkastella projektin aikataulutuspalvelun luomia virheitä valitsemalla **Asetukset** \> **Aikataulutuksen integrointi** \> **PSS-virhelokit**.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-685">To review errors generated from the Project Scheduling Service, go to **Settings** \> **Schedule Integration** \> **PSS Error Logs**.</span></span>

## <a name="sample-scenario"></a><span data-ttu-id="9b2c5-686">Näyteskenaario</span><span class="sxs-lookup"><span data-stu-id="9b2c5-686">Sample scenario</span></span>

<span data-ttu-id="9b2c5-687">Tässä skenaariossa luodaan projekti, ryhmän jäsen, neljä tehtävää ja kaksi resurssivarausta.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-687">In this scenario, you will create a project, a team member, four tasks, and two resource assignments.</span></span> <span data-ttu-id="9b2c5-688">Seuraavaksi päivität yhden tehtävän, päivität projektin, poistat yhden tehtävän, poistat yhden resurssin määrityksen ja luot riippuvuuden.</span><span class="sxs-lookup"><span data-stu-id="9b2c5-688">Next, you will update one task, update the project, delete one task, delete one resource assignment, and create a task dependency.</span></span>
...
## <a name="additional-samples"></a><span data-ttu-id="9b2c5-689">Muita näytteitä</span><span class="sxs-lookup"><span data-stu-id="9b2c5-689">Additional samples</span></span>
