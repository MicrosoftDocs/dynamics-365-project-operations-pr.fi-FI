...
description: Tässä artikkelissa on tietoja siitä, miten projektin työmäärää ja työn edistymistä voidaan seurata.
author: ruhercul
ms.date: 02/15/2022
ms.topic: overview
...
Tarve seurata aikataulun edistymistä vaihtelee toimialoittain. Joillakin toimialoilla seurataan yksityiskohtaisella tasolla, kun taas muilla toimialoilla seurataan korkeammalla tasolla. Tässä artikkelissa käsitellään siten, miten aikataulutus voidaan tehdä oman organisaation tarpeiden mukaan.
