...
description: Tässä artikkelissa on esimerkkejä projektisopimuksista, joita voi luoda erityyppisille projekteille ja rahoituslähteille, sekä siitä, miten voit hallita palvelusopimuksia ja laskuttaa projektiasiakkaita.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
