...
description: Tässä artikkelissa käsitellään projektin työn ja kulujen vakiokustannukset määrittämistä.
author: Yowelle
ms.date: 08/02/2019
...
Tässä artikkelissa käsitellään projektin työn ja kulujen vakiokustannukset määrittämistä. Tämä tehtävä käyttää USSI-tietojoukkoa.
