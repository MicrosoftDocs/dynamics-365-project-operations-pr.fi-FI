...
description: Tässä artikkelissa käsitellään parametreja, joilla hallitaan yleistä toimintaa kulujen hallinnassa.
author: suvaidya
ms.date: 10/01/2020
ms.topic: article
...
ms.locfileid: "8931464"
---
# <a name="configure-expense-management-parameters"></a>Kulujen hallintaparametrien määrittäminen

_**Käytetään:** Project Operationsin resursseihin ja ei-varastoitaviin perustuvissa skenaarioissa_

Tässä artikkelissa käsitellään parametreja, joilla hallitaan yleistä toimintaa kulujen hallinnassa.
