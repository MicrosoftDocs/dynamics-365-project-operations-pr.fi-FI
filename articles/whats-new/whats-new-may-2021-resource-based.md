...
description: Tässä artikkelissa on tietoja Project Operationsin resursseihin ja ei-varastoitaviin perustuvissa skenaarioissa toukokuun 2021 julkaisussa saatavilla olevista laatupäivityksistä.
author: sigitac
ms.date: 05/11/2021
ms.topic: article
ms.prod: ''
...
- Projektinhallinta ja kirjanpito talous- ja toimintosovellusten ympäristön versiossa 10.0.18
...
Jos kartan käynnistyksessä ilmenee ongelmia, noudata kaksoiskirjoituksen vianmääritysoppaan ohjeita kohdasta [Karttojen puuttuvat taulukkosarakkeet -ongelma](/dynamics365/fin-ops-core/dev-itpro/data-entities/dual-write/dual-write-troubleshooting-finops-upgrades#missing-table-columns-issue-on-maps).
